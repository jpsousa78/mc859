...
ifeq ($(shell uname), Darwin)
	...
	CC_ARGS    = -m64 -g -ferror-limit=2 -Wall -std=c++11 -D_GLIBCXX_USE_CXX11_ABI=0
...
_EX_SEM_GUROBI = ex_shortestpath.cpp ex_greedycoloring.cpp ex_graphtable.cpp ex_mycolor.cpp ex_visualcolors.cpp ex_basics_graph.cpp generate_cflp.cpp generate_random_euclidean_graph.cpp generate_random_graph.cpp generate_bipartite_vertex_cover.cpp generate_triangulated_digraph.cpp generate_triangulated_graph.cpp generate_steiner_file.cpp ex_viewgraph.cpp ex_viewdigraph.cpp  generate_pickup_delivery_digraph.cpp mc859-compras-gera-entrada.cpp mc859-compras.cpp mc859-ranking-gera-entrada.cpp mc859-ranking.cpp

_EX_COM_GUROBI = ex_steiner_undirected.cpp ex_coloring.cpp  ex_fractional_packing.cpp ex_knapsack.cpp ex_tsp.cpp ex_fractional_tsp.cpp  ex_steiner_directed.cpp  ex_kpaths.cpp ex_cflp.cpp ex_bipartite_matching.cpp ex_bipartite_matching2.cpp ex_perfect_matching_general_graphs.cpp ex_viewgraph.cpp ex_viewdigraph.cpp ex_vertex_cover_in_bipartite_graph.cpp ex_pickup_delivery.cpp
